...
Lithos has six subcommands. For flag-level detail, run `lithos --help` or
...
searches the current directory. If it is a directory, Lithos searches inside
it. If it is a file, Lithos uses that file directly. See
