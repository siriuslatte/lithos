...
that turns a `lithos.yml` / `lithos.yaml` into a sequence of Roblox API calls.
...
- `config` — parse and validate `lithos.yml` / `lithos.yaml` plus legacy `mantle.yml` / `mantle.yaml`.
